...
SELECT p.product, COUNT(sp.id_product) AS cantidad_vendida
...
--33
-- ¿Cuál es el promedio de artículos comprados por venta?
SELECT AVG(articles) AS promedio_articulos_por_venta FROM sale;


--34
-- ¿Cuál es el país con mayor cantidad de clientes?
